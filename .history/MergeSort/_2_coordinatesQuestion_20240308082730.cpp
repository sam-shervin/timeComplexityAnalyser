...
#include <vector>
#include <ctime>
#define INT_MAX_NUM 99999999999
using namespace std;
...
struct Point
{
    ...
    {
        Point result;
        if (this->x == INT_MAX_NUM || other.x == INT_MAX_NUM || this->y == INT_MAX_NUM || other.y == INT_MAX_NUM)
        {
            result.x = INT_MAX_NUM;
            result.y = INT_MAX_NUM;
        }
        else
        {
