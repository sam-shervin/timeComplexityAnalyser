...
int main()
{
    ...
    vector<int> numPoints = {500, 1000, 5000, 10000, 50000, 100000, 500000, 1000000};
    ...
    // display coordinates x and y in figure  by using plt::annotate
    for (int i = 0; i < numPoints.size(); i++)
    {
        plt::annotate(to_string(numPoints[i]), numPoints[i], tX_values[i]);
        plt::annotate(to_string(numPoints[i]), numPoints[i], tY_values[i]);
        plt::annotate(to_string(numPoints[i]), numPoints[i], tXY_values[i]);
    }
